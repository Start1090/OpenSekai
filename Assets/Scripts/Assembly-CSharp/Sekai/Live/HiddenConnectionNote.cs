namespace Sekai.Live
{
	public class HiddenConnectionNote : NoteBase
	{
		...
		public HiddenConnectionNote()
		{
			Category = NoteCategory.Hidden;
		}

		public HiddenConnectionNote(MusicScoreInfo info, int id, int laneStart, int laneEnd, NoteCategory category, NoteType type, float speedRatio, float laneOffset, NoteLineType lineType = NoteLineType.Linear)
